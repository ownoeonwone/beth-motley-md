...
export default function BasecampForm() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      await fetch(endpoint, {
        ...
        body: JSON.stringify({ ...form, formName: 'basecamp-health-assessment' }),
      });
      setStatus('success');
    } catch {
      setStatus('error');
  ...
  if (status === 'success') {
    return (
      <div className="card text-center py-12 border-brand-200 bg-brand-50/30">
        ...
        <p className="text-body text-neutral-600">Thank you for your interest in the Basecamp Health Assessment. A member of Dr. Motley&apos;s team will contact you within 48 hours to schedule a confidential consultation.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <p className="text-small text-neutral-500 italic mb-6">All information is kept strictly confidential. This screening helps us determine if the Basecamp Health Assessment is the right fit for your needs.</p>
