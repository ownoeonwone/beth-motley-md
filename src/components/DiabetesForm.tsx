    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      {step === 2 && (
        <div className="space-y-5">
          ...
          <p className="text-small text-neutral-400 text-center mt-4 flex items-center justify-center gap-1.5">
            ...
            This form is HIPAA compliant. Your information is secure.
          </p>
        </div>
      )}
    </form>
