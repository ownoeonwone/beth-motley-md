...
export default function PracticeIntegrationForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <p className="text-small text-neutral-400 text-center mt-2 flex items-center justify-center gap-1.5">
        ...
        Your information is secure and will only be reviewed by Dr. Motley.
      </p>
    </form>
  );
}
